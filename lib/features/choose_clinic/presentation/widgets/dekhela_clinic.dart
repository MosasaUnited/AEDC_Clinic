...
class DekhelaClinic extends StatelessWidget {
  const DekhelaClinic({super.key});
      ...
      child: InkWell(
        ...
        child: const Card(
          ...
          child: Stack(
            fit: StackFit.expand,
            children: [
              ClinicImageAsset(image: ImageAssets.dekhelaClinicImage),
              CustomRichText(clinicTitle: 'الدخيلة')
            ],
          ),
        ),
      ),
