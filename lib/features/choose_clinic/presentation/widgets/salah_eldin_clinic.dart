...
class SalahEldinClinic extends StatelessWidget {
  const SalahEldinClinic({super.key});
      ...
      child: InkWell(
        ...
        child: const Card(
          ...
          child: Stack(
            fit: StackFit.expand,
            children: [
              ClinicImageAsset(image: ImageAssets.salahEldinClinicImage),
              CustomRichText(clinicTitle: 'صلاح الدين')
            ],
          ),
        ),
      ),
