...
class IbrahimyaClinic extends StatelessWidget {
  const IbrahimyaClinic({super.key});
      ...
      child: InkWell(
        ...
        child: const Card(
          ...
          child: Stack(
            fit: StackFit.expand,
            children: [
              ClinicImageAsset(image: ImageAssets.ibrahimyaClinicImage),
              CustomRichText(clinicTitle: 'الإبراهيمية'),
            ],
          ),
        ),
      ),
